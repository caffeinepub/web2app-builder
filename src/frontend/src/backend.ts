...
import type { ExternalBlob as _ExternalBlob, Features as _Features, Project as _Project, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addDownloadRecord(arg0: string, arg1: string): Promise<DownloadRecord> {
        if (this.processError) {
            try {
                const result = await this.actor.addDownloadRecord(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createProject(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: bigint, arg6: Features, arg7: string | null): Promise<Project> {
        if (this.processError) {
            try {
                const result = await this.actor.createProject(arg0, arg1, arg2, arg3, arg4, arg5, arg6, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg7));
    ...
    async getProjectIcon(arg0: string): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.getProjectIcon(arg0);
    ...
    async listMyDownloadHistory(): Promise<Array<DownloadRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.listMyDownloadHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProject(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: bigint, arg7: Features, arg8: string | null): Promise<Project> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProject(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg8));
                return from_candid_Project_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        iconKey: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.iconKey))
    };
}
